...
public class JsonSingletonStore<T> extends AbstractJsonStore<T, T> {
		 ...
		 */
		public JsonSingletonStore(Class<T> payloadClass, Integer payloadTypeVersion, FlexjsonHelper flexjsonHelper, File storage, Charset charset, boolean prettyPrint, boolean autoSave, VersionMigrationHandler... migrationHandlers) {
