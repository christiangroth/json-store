...
public class JsonStoreTest {
    ...
    public void init() {
        ...
        persistentStore = new JsonStore<>(String.class, null, flexjsonHelper, tempDir, StandardCharsets.UTF_8, true, true);
        persistentStoreCopy = new JsonStore<>(String.class, null, flexjsonHelper, tempDir, StandardCharsets.UTF_8, true, true);
        transientStore = new JsonStore<>(String.class, null, flexjsonHelper, null, null, false, false);
        transientStoreCopy = new JsonStore<>(String.class, null, flexjsonHelper, null, null, false, false);
